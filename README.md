Мой первый pet-проект в начале изучения языка программирования Golang.

- Написано приложение работающие с пользовательским вводом
...
- Есть возможность получать список всех произошедших за время работы программы событий
- Программа является модулем, и зависима от сторонней библиотеки (github.com/k0kubun/pp для красивого вывода)
- Программа содержит в себе 2 пакета, помимо main пакета
- 
---
- Список команд, доступные в приложении:
  - help
